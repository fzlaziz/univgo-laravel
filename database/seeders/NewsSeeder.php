    ...
    public function run(): void
    {
        ...
        if ($campusPolines) {
            ...
            [
                ...
                'attachment' => 'news-attachments/polines1.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'attachment' => 'news-attachments/polines2.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'attachment' => 'news-attachments/polines3.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ]);
        ...
        if ($campusUndip) {
            ...
            [
                ...
                'attachment' => 'news-attachments/undip1.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'attachment' => 'news-attachments/undip2.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'attachment' => 'news-attachments/undip3.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'attachment' => 'news-attachments/undip4.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ]);
